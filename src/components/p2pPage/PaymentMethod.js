...
const PaymentMethod = () => {
  ...
  return (
    <div className="relative inline-block text-left" ref={dropdownRef}>
      ...
      {isDropdownOpen && (
        <div className="dropdown-menu absolute top-full left-0   border border-gray-300 bg-white-300 rounded-md shadow-lg">
          <input
          ...
          <div className="dropdown-buttons flex justify-center p-2">
            <button className="confirm-button py-2 px-4 bg-blue-500 text-white rounded cursor-pointer mr-2" onClick={handleConfirmClick}>
              Confirm
            </button>
