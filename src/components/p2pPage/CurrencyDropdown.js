...
const CurrencyDropdown = () => {
  ...
  return (
    <div className="relative flex text-left rounded-full bg-white-300 " ref={dropdownRef}>
      <input
        type="text"
        value={searchInput}
        onChange={handleInputChange}
        placeholder="Enter Amount"
        className=" border-gray-300 rounded-full px-3 py-1 outline-none "
      />
      ...
      {isOpen && (
        <div className="origin-top-right absolute right-0 mt-10  rounded-md shadow-lg bg-white-500 ring-1 ring-black ring-opacity-5">
